...
def main():
    ...
    try:
        ...
        with open(OUTPUT_FILE_NAME, "w") as bank_output_file:
            ...
            # list out the bank name and its ₹2000 note denomination count for both may and june month
            ...
            # caculate total number of ₹2000 notes deposited in all the banks for both months
            ...
            # add new bank details to the list and figure out the max Rs 2000 notes deposited in which bank for may & June month.
            ...
            # calculate the total amount that collected so far for both months
            ...
            # remove two bank details from the list which shows max Rs 2000 note denominations for the may month.
            bank_output_file.write("\n")
            max_heap_pop(bank_details_may, key_func)
            max_heap_pop(bank_details_may, key_func)

            # print the max heap tree for both months
            write_bank_details(bank_output_file, bank_details_may, "may")
            bank_output_file.write("\n")
            write_bank_details(bank_output_file, bank_details_june, "june")
            sys.exit(0)
